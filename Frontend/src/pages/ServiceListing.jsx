                            ...
                            <div className='flex flex-col items-start justify-center'>
                                {filters.map((filter, index) =>
                                    <div key={index} className='!mt-6'>
                                        <span className='text-lg font-semibold'>{filter.title}</span>
                    ...
                    <div className='col-span-9 border-l border-gray-500 !pl-2'>
                        ...
                        <div className='flex flex-col px-2'>
                            <div className='flex justify-between items-center border-b border-gray-500 pb-2'>
                                ...
                                <div className='border !border-gray-500 !rounded !px-2 !py-0.5 !text-base flex items-center'>
                        ...
                        <div>
                            {hospitalDetails.map((detail) =>
                                <>
                                    <div key={detail.id} className='grid grid-cols-10 !gap-x-4 !mt-6 !mb-6 !px-2'>
                                        ...
                                        <div className='col-span-6 flex flex-col justify-between'>
                                            ...
                                            <div className='flex justify-between items-start'>
                                                ...
                                                <div className='flex flex-col'>
                                                    <span className='text-3xl font-bold !text-gray-700'>{detail.hName}</span>
                                                    <span className='text-lg font-semibold !text-gray-700'>{detail.location}, {detail.city}</span>
                                                </div>

                                                {/* RATING AND REVIEW COUNT */}
                                                <div className='flex flex-col items-end'>
                                                    <div className="flex items-center">
                                                        <span className='text-lg mr-1 text-[#28A745]'>{detail.rating}</span>
                                                        {Array(5).fill().map((_, index) => (
                                                            <FaStar key={index} className="text-[#28A745] w-5 h-5 flex-shrink-0" />
                                                        ))}
                                                    </div>
                                                    <span className='!text-gray-500'>{detail.reviews} Reviews</span>
                                                </div>
                                            ...
                                            <div className='flex flex-col !space-y-2.5'>
                                                ...
                                                <div className='flex justify-between items-end'>
                                                    ...
                                                    {/* BEDS COUNT AND TYPE */}
                                                    <div className='flex flex-col'>
                                                        <span className='text-base font-semibold !text-gray-700'>{detail.beds} Beds</span>
                                                        <span className='text-base font-semibold !text-gray-700'>{detail.type}</span>
                                                    </div>

                                                    {/* CONTACT NO */}
                                                    <div className='flex items-center'>
                                                        <FaPhoneAlt className='h-4 w-4 mr-2 flex-shrink-0' />
                                                        <span className='text-base font-semibold !text-gray-700'>{detail.contactNo}</span>
                                                    </div>
