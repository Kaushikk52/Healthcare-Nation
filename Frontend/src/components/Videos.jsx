          ...
          <div
            ...
            <div className='!relative'>
              ...
              <div className='!absolute !bottom-1 !right-2'>
                <span className=' !px-2 !rounded-sm !text-sm !bg-black !bg-opacity-80 !text-white'>{video.duration}</span>
              </div>
            </div>

            <div className='!py-2.5 !px-2.5'>
              <span className='!line-clamp-2 !text-md !font-semibold !text-gray-900 !mt-0.5'>{video.title}</span>
              <div className='!flex !justify-start !space-x-2.5 !items-center !py-2'>
                  <span className='!text-gray-500 !text-sm'>{video.views}</span>
                  <span className='!text-gray-500 !text-sm !flex !items-center'><GoDotFill className='!h-3 !w-3 !mr-1 !text-gray-400'/> {video.relativeTime}</span>
              </div>
            </div>
