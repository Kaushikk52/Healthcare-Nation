...
import { FaStar, FaPhoneAlt, FaFilter } from "react-icons/fa";
    ...
    return (
        <>
            <div className='relative'>
                ...
                {/* FILER FOR SMALL SCREENS */}
                <AnimatePresence >
                    {filterOpen &&
                        <motion.div
                            onClick={() => setFilterOpen(false)}
                            className={`md:hidden fixed inset-0 !h-full z-40 !bg-[rgb(0,0,0,0.5)]`}
                            initial={{ opacity: 0 }}
                            animate={{ opacity: 1 }}
                            exit={{ opacity: 0 }}
                        ...
                        >
                            <motion.div
                                ...
                                className={`fixed  !h-screen top-0 left-0 z-50 !w-52 sm:!w-60 !bg-white  ${filterOpen ? 'translate-x-0' : '-translate-x-full'}`}
                                initial={{ x: "-100%" }}
                                animate={{ x: "0%" }}
                                exit={{ x: "-100%" }}
                                transition={{ type: "tween", duration: 0.2, ease: "easeInOut" }}
                            >
                                <div className='!flex !flex-col !items-start !justify-center !px-4 sm:!px-10'>
                ...
                <div className='!max-w-7xl !mx-auto !px-4'>
                    ...
                    {/* HEADING OF SERVICE */}
                    <div className='!mt-3 flex justify-between items-start min-[425px]:!items-center sm:!px-2 md:!px-0'>
                        <span className='!text-xl sm:!text-2xl !font-semibold'>Pediatric Hospitals in Mumbai</span>
                        <button onClick={() => setFilterOpen(true)} className='md:!hidden !flex !items-center !space-x-1 !border !border-black !py-0.5 !px-3 !rounded-sm'>
                            <FaFilter className='!h-3 !w-3 !flex-shrink-0' />
