...
import { FaStar, FaPhoneAlt, FaFilter, FaChevronDown } from "react-icons/fa"
...
export default function ServiceListing() {
  ...
  const handleBedRangeInput = (type, value) => {
    ...
    } else if (type === "max" && numValue >= Number.parseInt(bedRangeInput.min)) {
            ...
            <ol className="inline-flex items-center space-x-1 md:space-x-3">
              ...
              <li>
                <div className="flex items-center">
                  ...
                  <a href="#" className="ml-1 text-sm font-medium text-gray-700 hover:text-green-600 md:ml-2">
                    Mumbai
                  </a>
                </div>
              </li>
              <li aria-current="page">
                <div className="flex items-center">
                  ...
                  <span className="ml-1 text-sm font-medium text-gray-500 md:ml-2">Pediatric Hospital</span>
                </div>
              </li>
            </ol>
          </nav>
            ...
            >
              <div className="flex justify-between items-center mb-6">
                ...
                <div className="flex items-center gap-4">
                  <button onClick={clearAllFilters} className="text-green-500 text-sm hover:text-green-600">
                    Clear all
                  </button>
                    ...
                    {section.type === "slider" ? (
                      <div className="px-2 py-4">
                        <div className="flex gap-4 mb-4">
                          <div className="flex-1">
                            ...
                            <input
                              ...
                              onChange={(e) => handleBedRangeInput("min", e.target.value)}
                          ...
                          <div className="flex-1">
                            ...
                            <input
                              ...
                              onChange={(e) => handleBedRangeInput("max", e.target.value)}
                              className="w-full px-2 py-1 border rounded text-sm"
                        ...
                        <Slider
                          ...
                          onValueChange={(value) => {
                            setBedRange(value)
                            setBedRangeInput({ min: value[0].toString(), max: value[1].toString() })
                          }}
                        />
          ...
          <div className="flex-1">
            ...
            <div className="flex justify-between items-center mb-6 sm:px-2">
              ...
              <div className="flex flex-wrap gap-2">
                ...
                {(selectedFilters.length > 0 || bedRange[0] !== 0 || bedRange[1] !== 500) && (
                  <button
                    onClick={() => {
                      clearAllFilters()
                      setBedRange([0, 500])
              ...
              <div className="relative ml-auto">
                ...
                >
                  <span><span className="phone-none">Sort by:</span> {sortOptions.find((option) => option.value === sortBy)?.label}</span>
                  <FaChevronDown
                    className={`ml-2 h-5 w-5 text-gray-400 ${sortDropdownOpen ? "transform rotate-180" : ""}`}
                  />
                </button>
                ...
                {sortDropdownOpen && (
                  <div className="absolute z-10 w-32 md:w-48 mt-1 bg-white shadow-lg rounded-md py-1">
                    {sortOptions.map((option) => (
                      ...
                      >
                        <span className="phone-none">{option.prefix}</span>{option.label}
                      </button>
                    ))}
                  </div>
                )}
                ...
                <React.Fragment key={detail.id}>
                  <div className="grid grid-cols-1 lg:grid-cols-10 gap-x-4 gap-y-2 mt-6 mb-6 sm:px-2">
                    ...
                    <div className="lg:col-span-4">
                      <img
                        src={path + detail.image || "/placeholder.svg"}
                        alt={detail.hName}
                        className="rounded aspect-[12/7] object-cover w-full"
                      />
                    </div>
