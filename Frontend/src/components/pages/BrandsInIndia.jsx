        ...
        <div className="">
          ...
          <div className="!grid !grid-cols-2 sm:!grid-cols-3 lg:!grid-cols-6 xl:!grid-cols-6 !gap-x-4 !gap-y-5 md:!gap-y-6 !mt-4 sm:!mt-6 !mb-10">
            {popularBrands.map((brand, index) => (
              ...
              >
                <Link to={`/listing?type=hospitals&brands=${brand.title}`}>
                  <div className="flex items-center justify-center overflow-hidden !text-center bg-white !border-2 !border-gray-300 !rounded-full !h-32 !w-32 min-[425px]:!h-36 min-[425px]:!w-36 sm:!h-36 sm:!w-36 md:!h-40 md:!w-40 lg:!h-32 lg:!w-32 xl:!h-40 xl:!w-40">
                    <img
