...
import { CenterSchema } from "@/Validations/Center";
...
export default function EditCenterForm() {
  ...
  async function uploadSingleImage(
    ...
    try {
      toast.loading("Uploading Center Images ...", {
        position: "bottom-right",
        duration: 2000,
      });
  ...
  async function handleSubmit(
    ...
    try {
      ...
      const response = await axios.post(
        `${baseURL}/v1/api/center/edit`,
        { center: updatedValues, imagesToDelete: imagesToDelete },
        {
      ...
      if (response.status === 200) {
        showToast("Center information updated successfully!", "success");
      ...
      >
        <div>
          ...
          <p className="mt-2 text-center text-sm text-gray-600">
            Please fill the details of your center
          </p>
        </div>
                    ...
                    <div className="grid grid-cols-2 gap-6">
                      ...
                      <div>
                        ...
                        >
                          ...
                          <option value="ivf">
                            Test Tube Baby / IVF Center
                          </option>
                          <option value="rehabilitation">
                            Rehabilitation / De Addiction Center
                          </option>
                          <option value="burns">Burns Center</option>
                          <option value="hairTransplant">
                            Hair Transplant Center
                          </option>
                          <option value="checkup">Health Checkup Center</option>
                        </Field>
                        <ErrorMessage
                          name="type"
                          component="div"
                    ...
                    <div className="!mt-6">
                      ...
                      <MultipleSelector
                        value={values.concerns
                          .filter((c) => c.trim())
                          .map((c) => {
                            const option = concernsOptions.find(
                              (opt) => opt.value === c
                            );
                            return option
                        ...
                        onChange={(newValue) => {
                          ...
                          const selectedConcerns = newValue.map(
                            (item) => item.value
                          );
                          ...
                          const selectedSpecialities = newValue
                            .map((item) => {
                              const found = concernsOptions.find(
